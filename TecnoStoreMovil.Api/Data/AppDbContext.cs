...
namespace TecnoStoreMovil.Api.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder b)
        {
            ...
            b.Entity<Rol>().HasIndex(x => x.Nombre).IsUnique();
            ...
            b.Entity<Direccion>().HasIndex(x => x.UsuarioId).IsUnique();
            ...
            b.Entity<Categoria>().HasIndex(x => x.Nombre).IsUnique();
            ...
            b.Entity<Producto>().Property(x => x.Precio).HasColumnName("precio").HasColumnType("decimal(12,2)");
            ...
            b.Entity<Producto>().HasIndex(p => p.Nombre).IsUnique();
            ...
            b.Entity<Pedido>().Property(x => x.Total).HasColumnName("total").HasColumnType("decimal(12,2)");
            ...
            b.Entity<PedidoItem>().Property(x => x.PrecioUnit).HasColumnName("precio_unit").HasColumnType("decimal(12,2)");
            ...
            b.Entity<PedidoItem>().HasIndex(i => new { i.PedidoId, i.ProductoId }).IsUnique();

            b.Entity<Carrito>().ToTable("carrito", "dbo");
            b.Entity<Carrito>().Property(c => c.Id).HasColumnName("id");
            b.Entity<Carrito>().Property(c => c.UsuarioId).HasColumnName("usuario_id");
            b.Entity<Carrito>().Property(c => c.Estado).HasColumnName("estado"); // "Abierto"/"Cerrado"
            b.Entity<Carrito>().Property(c => c.FechaCreacion).HasColumnName("fecha_creacion");
            ...
            b.Entity<Carrito>().HasIndex(c => c.UsuarioId).HasDatabaseName("IX_carrito_usuario");

            b.Entity<Carrito>()
                .HasIndex(c => c.UsuarioId)
                .HasFilter("[estado] = N'Abierto'")
                .IsUnique()
                .HasDatabaseName("IXU_carrito_usuario_abierto");

            b.Entity<CarritoItem>().ToTable("carrito_item", "dbo");
            b.Entity<CarritoItem>().Property(ci => ci.Id).HasColumnName("id");
            b.Entity<CarritoItem>().Property(ci => ci.CarritoId).HasColumnName("carrito_id");
            b.Entity<CarritoItem>().Property(ci => ci.ProductoId).HasColumnName("producto_id");
            b.Entity<CarritoItem>().Property(ci => ci.Cantidad).HasColumnName("cantidad");
            b.Entity<CarritoItem>().Property(ci => ci.PrecioUnit).HasColumnName("precio_unit").HasColumnType("decimal(12,2)");

            b.Entity<CarritoItem>()
            ...
            b.Entity<CarritoItem>()
                .HasIndex(ci => new { ci.CarritoId, ci.ProductoId })
                .IsUnique()
                .HasDatabaseName("UQ_carrito_item");
        }
    }
}
